...
export default async function Department(props: PageLangParam) {
	...
	const { t } = useLingui()
	const department = useDepartments().find(d => d.slug === "housing-infrastructure-communities")!
	return <Page>
		<PageContent>
			<Section>
				<H1>
			...
			<Section>
				<P>
					<Trans>HICC spent $14.5 billion in fiscal year (FY) 2024. This was 2.8% of the $513.9 billion in overall federal spending. The department ranked eighth among federal departments in total spending.</Trans>
				</P>

				<P>
					<Trans>HICC accounted for 2.8% of all federal spending in FY 2024. 10 government departments accounted for 73.2% of federal spending in FY 2024.</Trans>
				</P>
				<ChartContainer>
			...
			<Section>
				...
				<P>
					<Trans>Federal spending may shift over time due to population growth, changes in policy and programs, and emerging problems to address.</Trans>
				</P>
				<P>
					<Trans>When HICC was founded in FY 2005 as the Office of Infrastructure Canada, the department's spending has grown from $250,000 to over $14 billion, a significant increase in overall spending and mandate. In FY 2024, HICC accounted for 2.8% of all federal spending.</Trans>
				</P>
				<P>
				...
				<P>
					<Trans>Similarly, HICC expenditures experienced notable fluctuations during this period, surging from approximately $5.9 billion​ in 2019 (adjusted for inflation) to $14.5B in 2024.</Trans>
				</P>
				<ChartContainer>
			...
			<Section>
				...
				<P>
					<Trans>Federal departments often contain other entities including offices, crown corporations and agencies. In FY 2024, HICC entities with the highest expenditures were Office of Infrastructure Canada, the Canada Mortgage and Housing Corporation and the Windsor-Detroit Bridge Authority.</Trans>
				</P>
				<ChartContainer>
					<NoSSR>
						<MiniSankey />
