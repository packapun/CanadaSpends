...
export default async function Department(props: PageLangParam) {
	...
	const { t } = useLingui()
	const department = useDepartments().find(d => d.slug === "public-safety-canada")!
	return <Page>
		<PageContent>
			<Section>
				<H1>
			...
			<Section>
				<P>
					<Trans>Public Safety Canada spent $13.9 billion in fiscal year (FY) 2024, accounting for 2.7% of the $513.9 billion in total federal spending. While not among the largest departments by expenditure, Public Safety Canada plays a crucial role in national security and emergency management, working in tandem with multiple agencies to mitigate threats and enhance public safety.</Trans>
				</P>
			...
			<Section>
				...
				<P>
					<Trans>Federal spending on public safety fluctuates based on evolving security threats, emergency events, and changes in government policy. Since 2005 shortly after it was established, Public Safety Canada's expenditures have increased by 69.6%, reflecting heightened investments in counterterrorism, cyber defence, and disaster response capabilities. The department's share of the federal budget has remained relatively flat from 2.6% in 2005 to 2.7% in 2024.</Trans>
				</P>
				<P>
					<Trans>Major policy shifts, unforeseen events such as natural disasters, and global security concerns can significantly impact the department's annual spending. The COVID-19 pandemic, for example, led to a sharp increase in federal emergency response funding in 2020.</Trans>
				</P>
			...
			<Section>
				<H2>
					<Trans>How did Public Safety Canada spend its budget in 2024?</Trans>
				</H2>
				<P>
					<Trans>In FY 2024, Public Safety's budget was allocated across several key areas, including:</Trans>
				</P>
				<ChartContainer>
					<NoSSR>
						<MiniSankey />
			...
			<Section>
				...
				<P>
					<Trans>The Department is led by the <ExternalLink href="https://www.canada.ca/en/government/ministers/david-mcguinty.html">Minister of Public Safety</ExternalLink>, who is appointed by the Governor General on the advice of the Prime Minister and then formally sworn into office at Rideau Hall. They take the Oath of Office and the Oath of Allegiance and become a member of the King's Privy Council for Canada.</Trans>
				</P>
				<P>
