	...
	return <Page>
		<PageContent>
			<Section>
				...
				<Intro>
					<Trans>The Department of Finance (Finance Canada) is a central federal department
			...
			<Section>
				<P>
					<Trans>The Department of Finance spent $136.1 billion in fiscal year (FY) 2024. This
						was 26.4% of the $513.9 billion in overall federal spending. The department
						ranked first among federal departments in total spending.</Trans>
				</P>
			</Section>

			<Section>
				<H2>
					<Trans>The Department of Finance accounted for 26.4% of all federal spending in FY 2024.</Trans>
				</H2>
				<H3>
				...
				<P>
					<Trans>Federal spending may shift over time due to population growth, changes in policy and programs, and emerging problems to address. Since 1995, overall federal spending has risen 74.9%, while Department of Finance spending has increased 41.4%.</Trans>
				</P>
				<P>
					<Trans>Major legislation, internal or global economic conditions, and acute events like the COVID-19 pandemic can affect spending year to year. For example, the federal expenses fluctuated during the pandemic, rising from $410.2 billion (in 2024 dollars) in 2019 to $420 billion in 2020 and $720.3 billion in 2021</Trans>
				</P>
			</Section>

			<Section>
				<H2>
					<Trans>The Department of Finance's share of federal spending in FY 2024 was lower than FY 1995.</Trans>
				</H2>
				<H3>
					<Trans>Percentage of federal budget dedicated to Finance, FYs 1995-2024</Trans>
				</H3>
				<ChartContainer>
				...
				<P>
					<Trans>In FY 2024, Finance Canada transferred 66.2% of its total spending to provinces and territories. The chart below outlines all departmental spending.</Trans>
				</P>
			</Section>
			...
			<Section>
				<H2>
					<Trans>How did the Department of Finance spend its budget in 2024?</Trans>
				</H2>
				<H3>
