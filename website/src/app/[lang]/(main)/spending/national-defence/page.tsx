...
export default async function Department(props: PageLangParam) {
	...
	return <Page>
		<PageContent>
			...
			<Section>
				<ChartContainer>
					<H3><Trans>Percentage of federal budget dedicated to Defence, FYs 1995-2024</Trans></H3>
			...
			<Section>
				<P>
					<Trans>Federal spending may shift over time due to geopolitical tensions, defence modernization needs, and emerging threats such as cyber warfare. Since 1995, overall federal spending has risen 74.9%, while Department of National Defence spending has increased 59.9%.</Trans>
				</P>
				<P>
					<Trans>DND's spending grew less than overall spending, meaning its share of the federal budget decreased. In 2024, the department accounted for 6.7% of all federal spending, 0.6 percentage points lower than in 1995.</Trans>
				</P>
				<ChartContainer>
					<FederalSpendingChart />
				</ChartContainer>
				<P>
					<Trans>Major legislation, shifts in international security dynamics, and acute events such as Russia's invasion of Ukraine or Arctic sovereignty disputes can influence military spending.</Trans>
				</P>
				<P>
				...
				<P>
					<Trans>Most federal defence spending is categorized as either personnel-related or capital expenditures. Personnel costs cover wages, benefits, and pensions for military and civilian employees. Capital expenditures fund procurement, infrastructure, and weapons systems.</Trans>
				</P>
				<H3>
					<Trans>In FY 2024, 45.6% of DND spending was allocated to personnel salaries, benefits, and pensions. 14.7% was directed to procurement of machinery and equipment.</Trans>
				</H3>
				<ChartContainer>
					<H3><Trans>National Defence, Spending by Entity, FY 2024 (in billions)</Trans></H3>
			...
			<Section>
				<H2>
					<Trans>How did the Department of National Defence spend its budget in 2024?</Trans>
				</H2>
				<P>
					<Trans>Federal departments often include additional agencies, commands, and operational divisions. In FY 2024, the largest spending entities within DND were the Canadian Army, the Royal Canadian Navy, and the Royal Canadian Air Force, accounting for the bulk of military expenditures.</Trans>
				</P>
				<ChartContainer>
					<NoSSR>
						<MiniSankey />
