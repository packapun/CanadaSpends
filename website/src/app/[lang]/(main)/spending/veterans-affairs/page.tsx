	...
	return <Page>
		<PageContent>
			<Section>
				...
				<Intro>
					<Trans>The Department of Veterans Affairs Canada (VAC) is the federal department responsible for supporting and serving Canadian veterans, active-duty military personnel, and their families. It provides financial assistance, healthcare support, rehabilitation services, and recognition programs to honor the contributions of those who have served in the Canadian Armed Forces. Additionally, the department is responsible for remembrance initiatives that preserve Canada's military history.</Trans>
				</Intro>
			</Section>
			...
			<Section>
				<P>
					<Trans>VAC spent $6.1 billion in fiscal year (FY) 2024. This was 1.2% of the $513.9 billion in overall federal spending. The department ranked thirteenth among federal departments in total spending.</Trans>
				</P>

				<H3>
					<Trans>VAC accounted for 1.2% of all federal spending in FY 2024. 10 government departments accounted for 73.2% of federal spending in FY 2024</Trans>
				</H3>
				<ChartContainer>
			...
			<Section>
				<P>
					<Trans>Federal spending may shift over time due to population growth, changes in policy and programs, and emerging problems to address. Since 1995, overall federal spending has risen 77%, while VAC spending has increased 51%.</Trans>
				</P>
				<P>
					<Trans>The department's spending has grown less than overall spending, which means that the department's share of the federal budget has increased. In FY 2024, VAC accounted for 1.1% of all federal spending, about the same share as in 1995.</Trans>
				</P>
				<P>
				...
				<P>
					<Trans>VAC's expenditures also grew slightly during this period, increasing from approximately $5.5B​ in 2019 when adjusted for inflation to $6.3B in 2024.</Trans>
				</P>
			</Section>
			...
			<Section>
				<P>
					<Trans>In FY 2024, VAC reported total expenditures of $6.07 billion across two entities:</Trans>
				</P>
				<ChartContainer>
