...
export default async function Department(props: PageLangParam) {
	...
	const { t } = useLingui()
	const department = useDepartments().find(d => d.slug === "health-canada")!
	return <Page>
		<PageContent>
			<Section>
				<H1>
			...
			<Section>
				<P>
					<Trans>Health Canada spent $13.7 billion in fiscal year (FY) 2024. This was 2.7% of the $513.9 billion in overall federal spending. The department ranked tenth among federal departments in total spending.</Trans>
				</P>

				<P>
					<Trans>Health Canada accounted for 2.7% of all federal spending in FY 2024. 10 government departments accounted for 73.2% of federal spending in FY 2024</Trans>
				</P>
			...
			<Section>
				...
				<P>
					<Trans>Federal spending may shift over time due to population growth, changes in policy and programs, and emerging challenges. Since FY 1995, overall federal spending has risen 74.9%, while Health Canada spending has decreased 19.9% when adjusted for inflation.</Trans>
				</P>
				<P>
					<Trans>The department's spending grew at a rate significantly lower than overall spending, reflecting shifts in federal priorities. In FY 2024, Health Canada accounted for 2.7% of all federal spending, 3.14 percentage points lower than in 1995.</Trans>
				</P>
				<P>
					<Trans>Major legislation, internal or global economic conditions, and acute events like the COVID-19 pandemic can significantly influence government spending year to year. For example, during the COVID-19 pandemic, federal support programs led to a temporary surge in spending. Health Canada expenditures increased from $5 billion in FY 2019 to $14.2 billion in FY 2021 before stabilizing in recent years.</Trans>
				</P>
			...
			<Section>
				...
				<P>
					<Trans>Federal departments often contain other entities including offices, crown corporations and agencies. The Health Canada entities with the biggest expenditures in FY 2024 were</Trans>
				</P>
				<ChartContainer>
					<NoSSR>
						<MiniSankey />
