...
export default async function Department(props: PageLangParam) {
	...
	return <Page>
		<PageContent>
			...
			<Section>
				<P>
					<Trans>PSPC spent $8.3 billion in fiscal year (FY) 2024. This was 1.6% of the $513.9 billion in overall federal spending. The department ranked twelfth among federal departments in total spending.</Trans>
				</P>

				<P>
					<Trans>PSPC accounted for 1.6% of all federal spending in FY 2024. 10 government departments accounted for 73.2% of federal spending in FY 2024</Trans>
				</P>
			</Section>
			...
			<Section>
				<P>
					<Trans>Federal spending may shift over time due to population growth, changes in policy and programs, and emerging problems to address. Since 1995, overall federal spending has risen 74.9%, while PSPC spending has increased by 7.1% when adjusted for inflation.</Trans>
				</P>
				<P>
					<Trans>The department's spending has increased less than overall spending has grown and the department's share of the federal budget has decreased over time. In FY 2024, PSPC accounted for 1.6% of all federal spending, 1 percentage point lower than in 1995.</Trans>
				</P>
				<P>
				...
				<P>
					<Trans>Similarly, PSPC's expenditures experienced notable fluctuations during this period, decreasing from approximately $6.8 billion​ in 2019 (adjusted for inflation) to $5.3 billion in 2021 before increasing again in 2024.</Trans>
				</P>
			...
			<Section>
				<P>
					<Trans>Federal departments often contain other entities including offices, crown corporations and agencies. In FY 2024, PSPC's budget was split across the following entities:</Trans>
				</P>
				<ChartContainer>
