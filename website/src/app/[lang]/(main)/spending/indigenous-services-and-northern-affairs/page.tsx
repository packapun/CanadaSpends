...
export default async function Department(props: PageLangParam) {
	...
	return <Page>
		<PageContent>
			...
			<Section>
				<P>
					<Trans>In fiscal year (FY) 2024, ISC and CIRNAC collectively spent <strong>$63 billion</strong>, accounting for <strong>12.1% of the total federal budget</strong>. The departments play a critical role in addressing socio-economic disparities, facilitating self-governance agreements, and improving service delivery for Indigenous communities across Canada.</Trans>
				</P>
			...
			<Section>
				<P>
					<Trans>Federal spending on Indigenous priorities may fluctuate over time due to population growth, policy shifts, and emerging challenges such as climate change and infrastructure deficits. Since 1995, total federal spending has risen by 74.9%, while spending on Indigenous priorities has increased by 592%, reflecting expanded program commitments and new governance agreements and claim settlements.</Trans>
				</P>
				<P>
					<Trans>Despite these increases, significant challenges remain in areas such as housing, healthcare access, and infrastructure in remote Indigenous communities.</Trans>
				</P>
				<ChartContainer>
			...
			<Section>
				...
				<P>
					<Trans>In FY 2024, ISC and CIRNAC transferred 93.1% of total spending directly to indigenous communities.</Trans>
				</P>
				<ChartContainer>
					<NoSSR>
						<MiniSankey />
				...
				<ChartContainer>
					<H3><Trans>ISC + CIRNAC, Spending by Entity, FY 2024 (in billions)</Trans></H3>
