import { SearchResult } from "../types/search"; // Import SearchResult if needed for types within utils
...
export const convertResultsToCsv = (results: SearchResult[]): string => {
  ...
  const headers = [
    'Recipient', 'Department', 'Program', 'Fiscal Year', 'Amount',
    'Description', 'Award Type', 'Sub type', 'Province', 'Country'
  ];
