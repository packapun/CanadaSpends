...
export async function generateMetadata({
  ...
  return {
    title: "Ontario Mines Spending | CanadaSpends",
    description: "Explore Ontario Mines spending including mining oversight, safety programs, and geological services.",
  };
}
...
export default async function MinesPage({
  ...
  const department = getDepartmentData("ontario", "mines");
  ...
  return (
    <Page>
      <PageContent>
        <Section>
          <H1>
            <Trans>Ontario Mines Spending</Trans>
          </H1>
          <Intro>
            <Trans>
              The Ministry of Mines regulates Ontario's mining sector through safety oversight, geological services, and mineral resource management. In fiscal year {jurisdiction.financialYear}, the ministry spent {department.totalSpendingFormatted}, representing {department.percentageFormatted} of Ontario's total budget. Key areas include mine safety inspection, geological surveys, and mining development oversight.
            </Trans>
          </Intro>
        </Section>
        ...
        <Section>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <StatCard
              ...
              value={<Trans>Mining Regulation</Trans>}
              subtitle={<Trans>Safety and geological services</Trans>}
            />
          </div>
        </Section>
        ...
        <Section>
          ...
          <P>
            <Trans>
              This chart shows how Mines allocates its {department.totalSpendingFormatted} budget across different programs and services, including mine safety inspection and enforcement, geological survey and mapping, mineral resource assessment, and mining development oversight.
            </Trans>
          </P>
        ...
        <Section>
          ...
          <P>
            <Trans>
              See how Mines spending compares to other Ontario government ministries and explore their detailed breakdowns.
            </Trans>
          </P>
