...
import ministryData from "@/data/ministries/office-of-the-lieutenant-governor-office-of-the-lieutenant-governor";

export function OfficeOfTheLieutenantGovernorOfficeOfTheLieutenantGovernorMiniSankey() {
	const { t } = useLingui()

	const data = useMemo(() => {
		// Use actual Office of the Lieutenant Governor → Office of the Lieutenant Governor ministry data from TypeScript module
		return {
