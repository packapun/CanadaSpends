...
import ministryData from "@/data/ministries/office-of-the-chief-electoral-officer-office-of-the-chief-electoral-officer";

export function OfficeOfTheChiefElectoralOfficerOfficeOfTheChiefElectoralOfficerMiniSankey() {
	const { t } = useLingui()

	const data = useMemo(() => {
		// Use actual Office of the Chief Electoral Officer → Office of the Chief Electoral Officer ministry data from TypeScript module
		return {
