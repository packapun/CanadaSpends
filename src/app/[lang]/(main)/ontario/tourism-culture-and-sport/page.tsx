...
export async function generateMetadata({
  ...
  return {
    title: "Ontario Tourism, Culture and Sport Spending | CanadaSpends",
    description: "Explore Ontario Tourism, Culture and Sport spending including tourism promotion, cultural programs, and sport development initiatives.",
  };
}
...
export default async function TourismCultureAndSportPage({
  ...
  const department = getDepartmentData("ontario", "tourism-culture-and-sport");
  ...
  return (
    <Page>
      <PageContent>
        <Section>
          <H1>
            <Trans>Ontario Tourism, Culture and Sport Spending</Trans>
          </H1>
          <Intro>
            <Trans>
              The Ministry of Tourism, Culture and Sport promotes Ontario's cultural heritage, tourism industry, and sport development. In fiscal year {jurisdiction.financialYear}, the ministry spent {department.totalSpendingFormatted}, representing {department.percentageFormatted} of Ontario's total budget. Key areas include tourism marketing, cultural grants, sport development, and heritage preservation.
            </Trans>
          </Intro>
        </Section>
        ...
        <Section>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <StatCard
              ...
              value={<Trans>Tourism & Culture</Trans>}
              subtitle={<Trans>Promotion and development</Trans>}
            />
          </div>
        </Section>
        ...
        <Section>
          ...
          <P>
            <Trans>
              This chart shows how Tourism, Culture and Sport allocates its {department.totalSpendingFormatted} budget across different programs and services, including tourism promotion, cultural and heritage programs, sport development initiatives, and community recreation support.
            </Trans>
          </P>
        ...
        <Section>
          ...
          <P>
            <Trans>
              See how Tourism, Culture and Sport spending compares to other Ontario government ministries and explore their detailed breakdowns.
            </Trans>
          </P>
