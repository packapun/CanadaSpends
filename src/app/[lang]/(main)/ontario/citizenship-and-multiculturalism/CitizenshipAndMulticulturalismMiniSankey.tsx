...
import ministryData from "@/data/ministries/citizenship-and-multiculturalism";

export function CitizenshipAndMulticulturalismMiniSankey() {
	const { t } = useLingui()

	const data = useMemo(() => {
		// Use actual Citizenship and Multiculturalism ministry data from TypeScript module
		return {
