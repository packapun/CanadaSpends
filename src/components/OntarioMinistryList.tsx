...
const MinistryItem = ({ lang, jurisdiction, name, slug }: MinistryProps) => {
  return (
    <div className="py-3 border-b border-gray-200">
      <InternalLink
        href={`/${lang}/${jurisdiction}/${slug}`}
...
export const OntarioMinistryList = (props: { current?: string }) => {
  const ministries = [
    ...
    },
    {
      ...
      slug: "office-of-the-chief-electoral-officer",
    },
    {
      name: "Office of the Lieutenant Governor",
      slug: "office-of-the-lieutenant-governor",
    },
  ...
  return (
    <div className="text-gray-600 leading-relaxed mb-4">
      {ministries
        ...
        .map((ministry) => (
          <MinistryItem key={ministry.slug} {...ministry} />
        ))}
      <div className="py-3 border-b border-gray-200">
